    ...
    >
      <div className="text px-10 md:px-40 flex flex-col items-center justify-center gap-4">
        <div className="heading p-2 md:py-5">
          <h1 className="font-black text-4xl md:text-6xl lg:text-7xl bg-gradient-to-b from-primary/90 to-primary/60 bg-clip-text text-transparent">
            Embark on Electrifying <br /> Adventures with
          </h1>
          <h1 className="text-9xl md:text-11xl lg:text-12xl font-bold text-center bg-gradient-to-b from-blue-400 to-blue-700 bg-clip-text text-transparent">
            Safar
          </h1>
        </div>
        <div className="desc">
          <h5 className="opacity-90 mx-auto text-center text-xl font-medium tracking-tight text-primary/80 md:text-2xl lg:text-3xl">
            Your trusted trip planner and adventure guide.
          </h5>
        </div>
        <div className="buttons flex flex-col gap-3 md:flex-row">
          <Link to="/plan-a-trip">
            <Button className="text-lg md:text-xl px-8 py-4 h-auto">
              {isAuthenticated
